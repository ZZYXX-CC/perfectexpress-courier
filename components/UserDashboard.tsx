...
const mockShipments = [
  { id: 'PX-882194', status: 'In Transit', origin: 'London, UK', destination: 'Austin, TX', estimatedArrival: 'Oct 24, 2024' },
  { id: 'PX-992301', status: 'Delivered', origin: 'Tokyo, JP', destination: 'London, UK', estimatedArrival: 'Oct 12, 2024' },
  { id: 'PX-774102', status: 'Pending', origin: 'Berlin, DE', destination: 'Paris, FR', estimatedArrival: 'Oct 28, 2024' },
  { id: 'PX-332110', status: 'Out for Delivery', origin: 'New York, US', destination: 'Brooklyn, US', estimatedArrival: 'Today' },
];
          ...
          >
             ...
             <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-bgSurface p-6 rounded-sm border border-borderColor">
                   ...
                   <p className="text-3xl font-black heading-font text-textMain">12</p>
                </div>
                <div className="bg-bgSurface p-6 rounded-sm border border-borderColor">
                   <div className="flex items-center gap-2 mb-4">
                   ...
                   <p className="text-3xl font-black heading-font text-textMain">148</p>
                </div>
